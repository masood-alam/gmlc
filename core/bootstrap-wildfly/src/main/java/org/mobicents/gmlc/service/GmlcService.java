...
public class GmlcService implements Service<GmlcService> {
  ...
  public void start(StartContext context) throws StartException {
	...
	log.info(ss7Service.getValue().getBeanTcapExecutor());
	log.info(ss7Service.getValue().getBeanSccpExecutor());
	log.info(ss7Service.getValue().getBeanM3uaShellExecutor());
	log.info(ss7Service.getValue().getBeanSctpShellExecutor());
	...
	log.info(shellExecutors);
      ...
      try {
        ...
        throw new StartException("schedulerMbean and/or shellExecutorMBean starting is failed: " + e.getMessage(), e);
      }
    }
  }
